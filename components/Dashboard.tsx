  ...
  return (
    <div className="space-y-4 animate-fadeIn pb-24 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-4 rounded-[1.5rem] border border-slate-100 shadow-sm">
        <div>
          <h2 className="text-xl font-black text-slate-900 uppercase tracking-tighter leading-none">Resumen Operativo <span className="text-[10px] text-emerald-500 font-bold ml-2">v5.4.4 FINAL STABLE</span></h2>
          ...
          <div className="relative z-10 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[7px] font-bold text-indigo-400 uppercase tracking-widest mt-1">v5.4.4 FINAL STABLE</p>
              </div>
            </div>
