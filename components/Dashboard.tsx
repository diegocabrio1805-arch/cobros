      ...
      {orders.length > 0 && (
        <div className="bg-[#0f172a] rounded-md border border-slate-800 shadow-xl overflow-hidden p-5">
           <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
              <h3 className="text-base font-bold text-white uppercase tracking-widest leading-none flex items-center gap-2">
              ...
              <div className="flex flex-col items-center sm:items-end gap-0.5">
                ...
                <span className="text-emerald-400 font-black font-mono text-lg" style={{fontFamily: "'Inter', sans-serif", fontWeight: 800, letterSpacing: '-0.02em'}}>
                  {formatCurrency(
                    orders.reduce((sum, o) => {
