...
const Profile: React.FC<ProfileProps> = ({ state, onUpdateUser }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fadeIn pb-24 px-1">
      <div className="bg-white p-6 md:p-8 rounded-none border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-4 w-full md:w-auto">
          <div className="w-12 h-12 md:w-16 md:h-16 bg-emerald-600 rounded-none flex items-center justify-center text-white text-2xl md:text-3xl font-black shadow-xl">
            {user.name.charAt(0)}
          </div>
          <div>
        ...
        <div className="bg-slate-100 px-4 py-2 rounded-none border border-slate-300">
          <span className="text-[10px] font-black text-slate-800 uppercase tracking-widest">{user.role}</span>
        </div>
      </div>

      <div className="bg-white p-6 md:p-8 rounded-none border border-slate-200 shadow-sm overflow-hidden relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full px-5 py-3.5 rounded-none border border-slate-300 focus:ring-2 focus:ring-emerald-500 focus:bg-white font-bold text-slate-950 outline-none transition-all ${!canEdit ? 'bg-slate-100 grayscale border-slate-200 cursor-not-allowed' : 'bg-slate-50'}`}
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  type="text"
                  value={user.role}
                  className="w-full px-5 py-3.5 rounded-none border bg-slate-100 border-slate-200 grayscale cursor-not-allowed font-black text-slate-500 uppercase text-[10px]"
                />
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full px-5 py-3.5 rounded-none border border-slate-300 focus:ring-2 focus:ring-emerald-500 focus:bg-white font-black text-slate-950 outline-none transition-all tracking-widest ${!canEdit ? 'bg-slate-100 grayscale border-slate-200 cursor-not-allowed' : 'bg-slate-50'}`}
              />
            </div>
            ...
            <div className="md:col-span-2 space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-5 py-4 rounded-none border bg-red-50 border-red-100 grayscale cursor-not-allowed font-black text-red-900 uppercase text-xs"
                />
          ...
          {canEdit ? (
            <div className="pt-4">
              <button
                type="submit"
                className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-none font-black uppercase text-xs tracking-widest shadow-xl active:scale-95 transition-all flex items-center justify-center gap-3"
              >
            ...
            <div className="p-4 bg-slate-100 border border-slate-200 rounded-none flex items-center gap-3">
              <i className="fa-solid fa-lock text-slate-400"></i>
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">{t.editAdmin}</p>
            </div>
          )}

          {showSuccess && (
            <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-none flex items-center gap-3 animate-slideIn">
      ...
      {(isAdmin || isManager) && state.settings.technicalSupportPhone && (
        <div className="bg-blue-600 p-8 rounded-none text-white flex items-center justify-between shadow-xl relative overflow-hidden group border border-white/20">
          <div className="relative z-10">
            ...
            <a
              ...
              className="flex items-center gap-3 bg-white/10 hover:bg-white/20 px-6 py-4 rounded-none transition-all border border-white/20 group/btn shadow-inner"
            >
          ...
          <div className="w-16 h-16 bg-white/10 rounded-none flex items-center justify-center text-blue-100 text-3xl shadow-inner border border-white/10">
      ...
      <div className="bg-slate-900 p-8 rounded-none text-white flex items-center justify-between shadow-xl relative overflow-hidden group">
        <div className="relative z-10">
        ...
        <div className="w-14 h-14 bg-white/10 rounded-none flex items-center justify-center text-emerald-400 text-2xl shadow-inner border border-white/10">
