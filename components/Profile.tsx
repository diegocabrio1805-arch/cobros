          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full px-5 py-3.5 rounded-2xl border border-slate-300 focus:ring-2 focus:ring-emerald-500 focus:bg-white font-bold text-slate-950 outline-none transition-all ${!canEdit ? 'bg-slate-100 grayscale border-slate-200 cursor-not-allowed' : 'bg-slate-50'}`}
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full px-5 py-3.5 rounded-2xl border border-slate-300 focus:ring-2 focus:ring-emerald-500 focus:bg-white font-black text-slate-950 outline-none transition-all tracking-widest ${!canEdit ? 'bg-slate-100 grayscale border-slate-200 cursor-not-allowed' : 'bg-slate-50'}`}
              />
            </div>
