-- ==============================================================================
-- SCRIPT DE SEGURIDAD V2: OWASP A01 (Strict Row Level Security)
-- ==============================================================================
...
-- 3. Crear Políticas Estrictas de Aislamiento usando snake_case
...
FOR ALL USING (
    auth.role() = 'authenticated' AND (
        ...
        OR (SELECT role FROM public.profiles WHERE id = auth.uid()::text) = 'Administrador'
    )
);
