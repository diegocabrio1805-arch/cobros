...
const App: React.FC = () => {
  ...
  const [state, setState] = useState<AppState>(() => {
    const CURRENT_VERSION_ID = 'v6.1.66-HOTFIX-MANAGER-RESTORE';
        ...
        <header className="md:hidden bg-white border-b border-slate-100 px-4 py-3 sticky top-0 z-[100] shadow-sm">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-black text-slate-400 bg-slate-100 px-2 py-0.5 rounded-md border border-slate-200 uppercase tracking-tighter">v6.1.66 PWA</span>
